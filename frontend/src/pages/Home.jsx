  ...
  return (
    <div className="home-container">
      <section className="welcome-section">
        <h1 className="heading">Rent the Perfect Car Seat for Your Child</h1>
        <p className="subheading">Welcome to Cozey Cradle, the premier destination for renting high-quality, safe, and comfortable car seats for your little ones. With Cozey Cradle, you can find the ideal car seat to ensure your child's safety and comfort during every journey.</p>
        <SearchBar />
      </section>
